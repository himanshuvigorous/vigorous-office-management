...
import { createWorkType } from "./WorkTypeFeatures/_work_type_reducers";
...
const CreateWorkType = () => {
  ...
  const onSubmit = (data) => {
    ...
    dispatch(createWorkType(finalPayload)).then((data) => {
        ...
        <form autoComplete="off" className="mt-2 md:px-1" onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="flex justify-end">
            <button
              ...
              className={`${workTypeLoading ? 'bg-gray-400' : 'bg-header'} text-white p-2 px-4 rounded mt-3`}
            >
