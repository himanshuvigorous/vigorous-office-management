...
function Employeepayment({ searchText, setSearchText }) {
  ...
  const [startDate, setStartDate] = useState(
    initialStartDate ? dayjs(initialStartDate) : getCurrentMonthDates().startOfMonth
  );
  const [endDate, setEndDate] = useState(
    initialEndDate ? dayjs(initialEndDate) : getCurrentMonthDates().endOfMonth
  );
