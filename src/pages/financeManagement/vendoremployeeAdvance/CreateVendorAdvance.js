...
import { createpurchaseExpence } from "../purchaseandexpence/purchaseandexpenceFeature/_purchaseandexpence_reducers";
import { createvendoremployeeAdvance } from "./vendoremployeeAdvanceFeature/_vendoremployeeAdvance_reducers";
import dayjs from "dayjs";
import Loader from "../../../global_layouts/Loader";
import ListLoader from "../../../global_layouts/ListLoader";


const CreateVendorAdvance = () => {
  const {
  ...
  const onSubmit = (data) => {
    ...
    dispatch(createvendoremployeeAdvance(finalPayload)).then((data) => {
                    ...
                    render={({ field }) => (
                      ...
                      >
                        ...
                        {vendorListLoading ? <Select.Option disabled>
                          ...
                          <Select.Option value={elment?._id}>{elment?.fullName}</Select.Option>
                        )))}
                      </Select>
                    )}
                  />
...
export default CreateVendorAdvance;
