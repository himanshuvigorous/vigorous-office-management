...
import { createServerManagement } from "./serverManagementFeatures/_server-management_reducers";

function CreateServer() {
  const { loading } = useSelector((state) => state.serverManagement);
  const {
    register,
    handleSubmit,
    setValue,
  ...
  const onSubmit = (data) => {
    ...
    dispatch(createServerManagement(reqData)).then((data) => {
      if (!data.error) {
        navigate(-1);
      }
    });
      ...
      <div className="gap-4">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-2 md:my-2">
            <div className="">
              <label className={`${inputLabelClassName}`}>
                Operating System Name <span className="text-red-600">*</span>
              </label>
              <input
                type="text"
            ...
            <div className="">
              <label className={`${inputLabelClassName}`}>
                Operating System Version <span className="text-red-600">*</span>
              </label>
              <input
                type="text"
                {...register("operatingSystem.version", {
                  required: "Operating System Version is required",
                })}
            ...
            <div className="">
              ...
              <input
                ...
                {...register("operatingSystem.architecture", {
                  required: "Operating System Architecture is required",
                })}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-2 md:my-2">
            <div className="">
              <label className={`${inputLabelClassName}`}>
                cores <span className="text-red-600">*</span>
              </label>
              <input
                type="number"
                step="any"
            ...
            <div className="">
              <label className={`${inputLabelClassName}`}>
                Threads <span className="text-red-600">*</span>
              </label>
              <input
                type="number"
                step="any"
            ...
            <div className="">
              <label className={`${inputLabelClassName}`}>
                speed <span className="text-red-600">*</span>
              </label>
              <input
                type="text"
                {...register("cpu.speed", {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-2 md:my-2">
            ...
            <div className="">
              <label className={`${inputLabelClassName}`}>
                Allocated <span className="text-red-600">*</span>
              </label>
              <input
                type="number"
          ...
          <div className={fields?.length > 0 ? " border-[1px] border-header rounded-md p-2" : ""}>        
              ...
              return (
                <div key={item?.id} className="">
                  <div className="flex font-semibold text-header justify-between items-center">
                    ...
                    <div className="flex justify-end">
                      <button
                        ...
                        className={` w-20 text-white px-2 py-1 rounded my-2 bg-red-500`}
                      >
                        Remove
                      </button>
                    </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-2 md:my-2">
                    ...
                    <div className="">
                      <label className={`${inputLabelClassName}`}>
                        used <span className="text-red-600">*</span>
                      </label>
                      <input
                        type="number"
                        step="any"
                    ...
                    <div className="">
                      <label className={`${inputLabelClassName}`}>
                        Mount Point <span className="text-red-600">*</span>
                      </label>
                      <input
                        type="text"
                        {...register(`fieldArray.${index}.mountPoint`, {
                          required: "mountPoint is required",
                        })}
          ...
          <div className="">
            <div className=" flex justify-between items-center">
              <label className={`${inputLabelClassName}`}>
                ports <span className="text-red-600">*</span>
              </label>
              <button
                type="button"
                onClick={() => appendPort()}
            ...
            <div className={portFields?.length > 0 ? " border-[1px] border-header rounded-md p-2" : ""}>
                ...
                return (
                  <div key={ports?.id} className="">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-2 md:my-2">
                      ...
                      <div className="">
                        <label className={`${inputLabelClassName}`}>
                          isOpen <span className="text-red-600">*</span>
                        </label>
                        <Controller
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-2 md:my-2">
            ...
            <div className="">
              <label className={`${inputLabelClassName}`}>
                sshKey <span className="text-red-600">*</span>
              </label>
              <input
                type="text"
                {...register("credentials.sshKey", {
                  required: "sshKey is required",
                })}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-2 md:my-2">
            <div className="">
              <label className={`${inputLabelClassName}`}>
                Hosting Provider <span className="text-red-600">*</span>
              </label>
              <Controller
            ...
            <div className="">
              <label className={`${inputLabelClassName}`}>
                Instance Type <span className="text-red-600">*</span>
              </label>
              <input
                type="text"
                {...register("hostingProvider.instanceType", {
                  required: "instanceType is required",
                })}
          ...
          <div className={servicesFields?.length > 0 ? " border-[1px] border-header rounded-md p-2" : ""}>
