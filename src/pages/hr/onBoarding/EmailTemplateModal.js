...
import { getOnBoardingDetails } from './onBoardingFeatures/_onBoarding_reducers';
...
const EmailTemplateModal = ({ isOpen, onClose, onSubmit, onBoardingData, setOnBoardingId }) => {

    const [formData, setFormData] = useState({
        to: '',
        cc: [],
        subject: 'Regarding onBoarding',
        employeeName: '',
        jobTitle: '',
        companyName: '',
        joiningDate: '',
    ...
    useEffect(() => {
        ...
        <h1 style="font-size: 24px; color: #0073e6;">Welcome to ${onBoardingData.companyData?.fullName}!</h1>
        ...
        <ul style="font-size: 16px; line-height: 1.5;">
            <li><span style="font-weight: bold;">Date:</span> ${moment(onBoardingData?.dateOfJoining).format('YYYY-MM-DD')}</li>
            <li><span style="font-weight: bold;">Reporting Time:</span> ${moment(onBoardingData?.dateOfJoining).format('HH:MM')}</li>
        ...
        <p style="font-size: 16px; line-height: 1.5;">${onBoardingData.companyData?.fullName}</p>
